...
Here are some [sample fıkras](https://github.com/arqcenick/MechanicalTemel/edit/master/data/Sample generated fıkras.zip) that are generated by the character-aware language model from Kim et al., trained on our preprocessed fıkra dataset. 

You can find the Te


This is an informative and easy to read [blog](http://ruder.io/#open) from Sebastian Ruder for beginner and intermediate level NLP researchers and those who are interested in NLP. The post are informative, simple to comrehend and they provide a nice overwiev for many various research areas in NLP. 
