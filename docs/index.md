...
Here are some [sample fıkras](https://github.com/arqcenick/MechanicalTemel/edit/master/data/Sample_generated_fıkras.zip) that are generated by the character-aware language model from Kim et al., trained on our preprocessed fıkra dataset. 
